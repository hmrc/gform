...
case object Address {
  val mandatoryFields = (id: FieldId) => List("street1", "town").map(id.withJSSafeSuffix)
  val optionalFields = (id: FieldId) => List("street2", "street3", "county", "uk", "postcode", "country").map(id.withJSSafeSuffix)
