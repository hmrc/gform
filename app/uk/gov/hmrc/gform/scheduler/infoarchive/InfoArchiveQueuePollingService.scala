...
class InfoArchiveQueuePollingService(
  actorSystem: ActorSystem,
  pollerInitialDelay: FiniteDuration,
  pollerInterval: FiniteDuration,
  pollerToggle: Boolean,
  infoArchiveQueueService: InfoArchiveQueueService
)(implicit ec: ExecutionContext)
    extends PollingService[SdesWorkItem](actorSystem, infoArchiveQueueService, pollerToggle) {

  override def name: String = "InfoArchivePollingService"
