...
sealed trait FormIdData {
  ...
  def withFormTemplateId(formTemplateId: FormTemplateId): FormIdData = fold[FormIdData] { p =>
    p.copy(formTemplateId = formTemplateId)
  } { w =>
    w.copy(formTemplateId = formTemplateId)
  }
}
