...
/**
  ...
  */
class GformConnector(ws: WSHttp, baseUrl: String)(implicit ec: ExecutionContext) {
  ...
  def deleteForm(formId: FormId)(implicit hc: HeaderCarrier): Future[Unit] =
  ...
  def submissionStatus(
    formId: FormId)(implicit hc: HeaderCarrier): Future[HttpResponse] =
    ws.GET[HttpResponse](s"$baseUrl/forms/${formId.value}/submission")

  /******formTemplate*******/
  def upsertTemplate(template: JsValue)(implicit hc: HeaderCarrier): Future[Unit] =
  ...
  def getFormTemplate(
    formTemplateId: FormTemplateId)(implicit hc: HeaderCarrier): Future[FormTemplate] =
  ...
  /******file-upload*******/
  def deleteFile(formId: FormId, fileId: FileId)(implicit hc: HeaderCarrier): Future[Unit] =
