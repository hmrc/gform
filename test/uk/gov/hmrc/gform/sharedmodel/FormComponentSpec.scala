...
class FormComponentSpec extends Spec {
  ...
  it should "parse as Text with 'mandatory' as boolean expression" in {
    val fieldValue = toFieldValue("""|{
                                     |  "id": "textId",
                                     |  "label": "Enter some text",
                                     |  "mandatory": "${otherFieldId contains 1}",
                                     |  "format": "shortText"
                                     |}""")

    fieldValue should beJsSuccess(
      FormComponent(
        FormComponentId("textId"),
        Text(ShortText.default, Value),
        toSmartString("Enter some text"),
        false,
        None,
        None,
        None,
        None,
        mandatory = Mandatory(Contains(FormCtx(FormComponentId("otherFieldId")), Constant("1"))),
        editable = true,
        submissible = true,
        derived = false,
        errorMessage = None
  ...
  it should "throw an error with 'mandatory' as illegal expression" in {
    val fieldValue = toFieldValue("""|{
                                     |  "id": "regNum",
                                     |  "label": "Registration number",
                                     |  "mandatory": "${illegal expression}",
                                     |  "format": "shortText"
                                     |}""")
  ...
  it should "throw an error with 'mandatory' as illegal text" in {
    val fieldValue = toFieldValue(s"""|{
                                     |  "id": "regNum",
                                     |  "label": "Registration number",
                                     |  "mandatory": "illegal text",
                                     |  "format": "shortText"
                                     |}""")
  ...
  it should "parse 'file upload' " in {
    ...
    fieldValue should beJsSuccess(
      FormComponent(
        ...
        toSmartString("Attach evidence of your income"),
        false,
        None,
        None,
        None,
  ...
  it should "parse the includeIf and correctly set it to it's Boolean Expression" in {
    ...
    fieldValue should beJsSuccess(
      FormComponent(
        ...
        None,
        None,
        Some(IncludeIf(Equals(FormCtx(FormComponentId("info")), Constant("Hello")))),
        None,
        Mandatory.TRUE,
        false,
        false,
